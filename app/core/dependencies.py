...
def get_booking_service(booking_repository: BookingRepository = Depends(get_booking_repository),
...
async def require_admin(current_user: Users = Depends(get_current_user)):
